...
string CSpeedKernel::GenerateCR()
{
    ...
    out << _T("</p>");
    out << _T("<br><br><br><br>");
    out << _T("<b>Automatically generated by <a href=\"http://www.speedsim.de.vu/eng\" target=\"_blank\">SpeedSim</a>");
...
void CSpeedKernel::ComputeLoot()
{
	...
	for(size_t i = 0; i < m_NumShipsAtt.size(); i++)
		LadeKap += (long)m_NumShipsAtt[i].Num * LadeKaps[m_NumShipsAtt[i].Type];
	tmplade = LadeKap;
